...
from website.views import home, criarAutomovelBD, criarAutomovel, criarSeguradora, criarSeguradoraBD, criarFatura, criarFaturaBD, mostrarDados, mostrarDadosBD
